...
@Autonomous(name = "Red Duck", group = "Linear Opmode")

public class RedDuckAutonomous extends AutonomousMethods {
    ...
    public void runOpMode() {
        ...
        toTargetDistance(14, Direction.RIGHT, 0.3, 4800, 24);
        sleep(120);
        detectLayer = duckDetection(true);

        // Duck spinning
        Log.d("AHHHHHH duck", "duck spinning started-----------------------------------------------------------------------------");
        toTarget(2.4, 9, Direction.BACKWARD, Direction.RIGHT, 24, 9, 0.6, 6000);
        sleep(360);
        toTarget(1, 6, Direction.BACKWARD, Direction.RIGHT, 18, 9, 0.6, 6000, 0.6);
        setRotationPosition(0.06, 0);
        myRobot.runLeftServo(-Constants.duckSpinPower);
        sleep(1500);
        myRobot.runLeftServo(-Constants.duckAutoSpinPower);
        sleep(900);
        myRobot.runLeftServo(0);

        // Dropping at shipping hub
        Log.d("AHHHHHH drop", "dropping started-----------------------------------------------------------------------------");
        toTarget(24, Constants.dropSide + Constants.sideOffset - 1.7, Direction.BACKWARD, Direction.RIGHT, 28, 39, 1, 9000);
