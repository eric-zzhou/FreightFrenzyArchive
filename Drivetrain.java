...
import org.firstinspires.ftc.teamcode.freightFrenzy.Configuration;
...
public class Drivetrain {
    ...
    public void initializeDriveTrain(HardwareMap hardwareMap, Telemetry telemetry_){
        ...
        //leftDistance = hardwareMap.get(DistanceSensor.class, skystoneNames.frontDistance);
        //backDistance = hardwareMap.get(DistanceSensor.class, skystoneNames.leftDistance);
        //frontDistance = hardwareMap.get(DistanceSensor.class, skystoneNames.RightDistance);
...
//    }
    ...
    public void drive(double direction, double velocity, double rotationVelocity) {
        ...
        // TODO: maybe make constant to adjust either just right side or just left side to make it be perfectly straight
        lf.setPower(w.lf);
        rf.setPower(w.rf);
        lb.setPower(w.lr);
        rb.setPower(w.rr);
