...
@Autonomous(name = "Blue Drop", group = "Linear Opmode")

public class BlueDropAutonomous extends AutonomousMethods {
    ...
    public void runOpMode() {
        ...
        sleep(120);
        detectLayer = distanceDetection(false);
        ...
        sleep(360);
        toTargetDistance(Constants.dropSide + 1 + Constants.sideOffset, Direction.RIGHT, 0.3, 7200, 54);
        ...
        toTargetDistance(6 + Constants.sideOffset, Direction.RIGHT, 0.3, 2400, 18);
        resetArmGap();
